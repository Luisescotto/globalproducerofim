import { c as createAstro, a as createComponent, m as maybeRenderHead, d as addAttribute, r as renderComponent, o as renderScript, b as renderTemplate, s as spreadAttributes, F as Fragment, u as unescapeHTML, p as renderHead, q as renderSlot } from './astro/server_DkevOTP5.mjs';
import 'kleur/colors';
import { t as toRoutingStrategy, g as getLocaleRelativeUrl } from './utils_pMoWUR6k.mjs';
import { $ as $$Image } from './_astro_assets_OL_b14iO.mjs';
...
var define_ASTRO_INTERNAL_I18N_CONFIG_default = { format: "directory", trailingSlash: "never", i18n: { defaultLocale: "en", locales: ["en", "es"], routing: { } }};
...
const $$SideMenu = createComponent(($$result, $$props, $$slots) => {
  ...
  const lang = getLangFromUrl(Astro2.url);
  const t = useTranslations(lang);
  return renderTemplate`${maybeRenderHead()}<div class="bg-black/70 backdrop-blur-xs w-screen h-full z-50 fixed top-0 right-0 hidden cursor-pointer" id="side_menu_bg"></div> <aside class="bg-secondary text-white p-6 fixed top-0 -right-[500px] h-screen w-[270px] z-60 border-l-2 border-white transition-all" id="side_menu"> <nav class="flex flex-col gap-4 pl-4"> <button class="p-2 rounded-md hover:bg-primary self-end" id="side_menu_close"> ${renderComponent($$result, "Icon", $$Icon, { "name": "close", "size": 32 })} </button> <ul class="flex flex-col gap-4"> <li> <a class="text-2xl text-white hover:bg-primary hover:underline px-2 py-2 rounded" href="/">${t("nav.home")}</a> </li> <li> <a class="text-2xl text-white hover:bg-primary hover:underline px-2 py-2 rounded" href="/about">${t("nav.about")}</a> </li> <li> <a class="text-2xl text-white hover:bg-primary hover:underline px-2 py-2 rounded" href="/products">${t("nav.products")}</a> </li> <li> <a class="text-2xl text-white hover:bg-primary hover:underline px-2 py-2 rounded" href="/contact">${t("nav.contact")}</a> </li> </ul> </nav> </aside> ${renderScript($$result, "C:/Users/luise/Documents/Astro/globalproducerofim/src/components/SideMenu.astro?astro&type=script&index=0&lang.ts")}`;
...
const FOOTER = {"FOOTER_TITLE":"Conéctate con Nosotros","CONTACT_INFO":{"ADDRESS":"Calle Principal, Las Cabuyas, La Vega, República Dominicana","PHONE":"+1-809-383-2022","EMAIL":"","SOCIAL_MEDIA_TITLE":"¡Síguenos en Instagram!","SOCIAL_MEDIA":{"INSTAGRAM":"https://www.instagram.com/globalproducerofim/"}},"COPYRIGHT":"© 2025 Trading Global Produce Rofim – Todos los derechos reservados"};
const spanish = {
  HOME,
  HERO_HOME,
  TABS,
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  const { currentLocale } = Astro2;
  return renderTemplate`<html lang="{currentLocale}" data-astro-cid-sckkx6r4> <head><meta charset="UTF-8"><meta name="description" content="Pagina web de Global Produce Rofim"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/ico" href="/favicon.ico"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head> <body class="font-inter" data-astro-cid-sckkx6r4> <div data-astro-cid-sckkx6r4> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-sckkx6r4": true })} ${renderComponent($$result, "SideMenu", $$SideMenu, { "data-astro-cid-sckkx6r4": true })} <main data-astro-cid-sckkx6r4> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-sckkx6r4": true })} </div> </body></html>`;
}, "C:/Users/luise/Documents/Astro/globalproducerofim/src/layouts/Layout.astro", void 0);

export { $$Icon as $, $$Layout as a, getI18N as g };
