...
import { V as VALID_INPUT_FORMATS } from './_astro_assets_BRry4TA6.mjs';
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, g as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, h as renderUniqueStylesheet, j as renderScriptElement, k as createHeadAndContent, r as renderComponent } from './astro/server_DBIoaZhA.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DdozHTII.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BRry4TA6.mjs').then(n => n._);
