...
import { V as VALID_INPUT_FORMATS } from './_astro_assets_OL_b14iO.mjs';
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, g as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, h as renderUniqueStylesheet, j as renderScriptElement, k as createHeadAndContent, r as renderComponent } from './astro/server_DkevOTP5.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CIqK_meh.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://www.globalproducerofim.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_OL_b14iO.mjs').then(n => n._);
