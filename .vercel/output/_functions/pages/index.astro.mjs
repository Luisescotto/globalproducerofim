import { c as createComponent, m as maybeRenderHead, r as renderComponent, a as renderTemplate, b as createAstro, d as addAttribute, s as spreadAttributes, n as renderSlot, k as renderScript, u as unescapeHTML } from '../chunks/astro/server_XqUvMMd3.mjs';
import 'kleur/colors';
import { a as $$Icon, $ as $$Layout } from '../chunks/Layout_B7LVy64e.mjs';
...
const $$HeroSearch = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="flex w-full h-screen overflow-hidden text-left z-0 relative min-h-96 justify-items-start items-center md:items-end"> <div class="z-30 relative pb-6 px-10 text-white"> <header class="flex flex-col flex-nowrap mb-4"> <h1 class="text-3xl sm:text-5xl md:text-7xl lg:text-8xl lg:pr-20 font-bold font-inter">
TRANDING GLOBAL PRODUCE ROFIM
</h1> <h2 class="text-xl md:text-2xl font-semibold -mt-2 font-inter">
Tropical Produce, Global Reach
</h2> </header> <div class="flex flex-col text-white"> <ul class="text-xl sm:2xl md:4xl lg:text-4xl font-light justify-center items-start flex flex-col gap-5"> <li class="flex"> ${renderComponent($$result, "Icon", $$Icon, { "class": "text-2xl sm:text-3xl lg:text-5xl", "name": "check-bold" })}<span>Premium Quality</span> </li> <li class="flex"> ${renderComponent($$result, "Icon", $$Icon, { "class": "text-2xl sm:text-3xl lg:text-5xl", "name": "check-bold" })}<span>Streamlined Logistics</span> </li> <li class="flex"> ${renderComponent($$result, "Icon", $$Icon, { "class": "text-2xl sm:text-3xl lg:text-5xl", "name": "check-bold" })}<span>Genuine Dominican Goods</span> </li> <li class="flex"> ${renderComponent($$result, "Icon", $$Icon, { "class": "text-2xl sm:text-3xl lg:text-5xl", "name": "plus-outline" })}<span>10 Years of Sector Expertise</span> </li> </ul> </div> </div> <div class="absolute top-0 bottom-0 w-full h-full z-10"> <img class="object-center h-full w-full object-cover" src="/heroBg.jpg" alt=""> </div> </section>`;
...
const $$HomeTabs = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="h-auto flex flex-col items-center py-12"> <h1 class="text-title font-bold border-b-2 border-acent text-4xl pt-4">
Our Products
</h1> <div class="w-auto mx-auto px-8 sm:px-0 flex items-center justify-center text-center pt-2"> ${renderComponent($$result, "Tabs", $$Tabs, { "defaultValue": "tropical", "class": "max-w-auto" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "TabsList", $$TabsList, { "class": "bg-white/0 text-acent" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "TabsTrigger", $$TabsTrigger, { "value": "oriental" }, { "default": ($$result4) => renderTemplate`ORIENTAL` })} ${renderComponent($$result3, "TabsTrigger", $$TabsTrigger, { "value": "tropical" }, { "default": ($$result4) => renderTemplate`TROPICAL` })} ${renderComponent($$result3, "TabsTrigger", $$TabsTrigger, { "value": "roots" }, { "default": ($$result4) => renderTemplate`ROOTS` })} ` })} ${renderComponent($$result2, "TabsContent", $$TabsContent, { "value": "oriental" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "HomeTabOriental", $$HomeTabOriental, {})} ` })} ${renderComponent($$result2, "TabsContent", $$TabsContent, { "value": "tropical" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "HomeTabTropical", $$HomeTabTropical, {})} ` })} ${renderComponent($$result2, "TabsContent", $$TabsContent, { "value": "roots" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "HomeTabRoots", $$HomeTabRoots, {})} ` })} ` })} </div> </section>`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Tranding Global Produce Rofim" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HeroSearch", $$HeroSearch, {})} ${renderComponent($$result2, "HomeTabs", $$HomeTabs, {})} ${maybeRenderHead()}<section class="w-full h-full bg-amber-700"> <div> <img class="w-full h-full" src="/bannerbg.jpg" alt=""> </div> </section> <section class="flex flex-col mt-6 w-full h-full"> <div class="flex justify-center items-center text-center"> <h1 class="text-title font-bold border-b-2 border-acent text-4xl pt-4">
Brands that truts us
</h1> </div> <div class="flex overflow-hidden"> <ul class="flex animate-loop-scroll py-10 gap-10"> ${[...brands, ...brands].map((brand) => {
    const { data } = brand;
  ...
  })} </ul> </div> </section> <section class="flex flex-col mt-6 w-full h-full"> <div class="flex justify-center items-center text-center"> <h1 class="text-title font-bold border-b-2 border-acent text-4xl pt-4">
Export Destinations
</h1> </div> <div class="flex overflow-hidden"> <ul class="flex animate-loop-inverse py-10 gap-10"> ${[...flags, ...flags].map((flag) => {
    const { data } = flag;
